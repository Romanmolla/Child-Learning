package com.roman.clildlearning.view
...
import com.roman.clildlearning.R
import java.util.*
import kotlin.collections.ArrayList

class AlphaBetAdapter(private val c:Context, private val alphaList:ArrayList<AlphaBets>):
...

{
    ...
    inner class AlphaViewHolder(val v:View):RecyclerView.ViewHolder(v){
        val alphaImgs: ImageView = v.findViewById<ImageView>(R.id.alphaImg)
